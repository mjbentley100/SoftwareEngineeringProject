...
def main():
	...
	# create text files of trees
	trtxt_gini = export_text(clf_gini)
	trtxt_entropy = export_text(clf_entropy)
	# write tree text to files
	tf1 = open("gini_text.txt", "w")
	tf1.write(trtxt_gini)
	tf1.close()
	tf2 = open("entropy_text.txt", "w")
	tf2.write(trtxt_entropy)
	tf2.close()
